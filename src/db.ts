import { Palette, Day, Palettes } from "./types";
...
function getDays() {
  return JSON.parse(localStorage.getItem('days') || '{}') as { [key: string]: Day };
}

function setDays(days: { [key: string]: Day }) {
