...
const Element = (props) => (_jsxs("form", { class: "page palettes", children: [_jsx("header", { children: _jsx("h1", { class: "app-name", children: "My Life In Color" }) }), _jsx("article", { children: _jsx("ul", { class: "palette-list", children: props.palettes.map((palette, i) => (_jsxs("li", { class: "palette-item", children: [_jsx("a", { href: `${location.pathname}?i=${i}`, class: "palette-link", children: palette.name }), _jsx("ul", { class: "colors", children: palette.colors.map(color => _jsx("li", { class: "color", style: `--color: ${color.hex}`, title: color.name, children: "\u00A0" })) })] }))) }) }), _jsx("footer", { children: _jsx("button", { onClick: props.onAddItemRequested, children: "Add Palette" }) })] }));
